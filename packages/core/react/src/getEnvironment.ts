import { SolanaMobileWalletAdapterWalletName } from 'tdc-publish-mobile/wallet-adapter-mobile';
import { type Adapter, WalletReadyState } from 'tdc-publish/wallet-adapter-base';
