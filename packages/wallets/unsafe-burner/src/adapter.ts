...
import { type SolanaSignInInput, type SolanaSignInOutput } from 'tdc-publish/wallet-standard-features';
import { createSignInMessage } from 'tdc-publish/wallet-standard-util';
import type { Transaction, TransactionVersion, VersionedTransaction } from 'tdc-publish/web3.js';
import { Keypair } from 'tdc-publish/web3.js';
...
export class UnsafeBurnerWalletAdapter extends BaseSignInMessageSignerWalletAdapter {
    ...
    url = 'https://github.com/duthanhdl97/tdc-wallet-adapter#usage';
    icon =
    ...
    constructor() {
        ...
        console.warn(
            'Your application is presently configured to use the `UnsafeBurnerWalletAdapter`. ' +
                ...
                'https://github.com/duthanhdl97/tdc-wallet-adapter#usage for an example.'
        );
    }
